...
# Unfortunately, ChemAxon is retiring Chemicalize on 30 June 2027. As of
# 02 July 2026, when I tried to use the web-based application to calculate
# properties using SMILES, the results showed:
#
# "Standardization of input molecule failed"
#
# Therefore, I believe that the web-based application is no longer being
# maintained. This occurred even with an academic subscription. At the time of
# creating the bulk uploads, around 23 January 2026, I had a business
# subscription and had no issues with the website.
#
